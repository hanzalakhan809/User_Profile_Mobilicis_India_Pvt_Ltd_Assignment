      ...
      <form className="bg-white rounded-2xl shadow-2xl flex flex-col w-full md:w-1/3 items-center max-w-4xl transition duration-1000 ease-out" onSubmit={handleSubmit(handleLogin)}>
        ...
        <div className='flex flex-col items-center justify-center'>
          <div className='flex flex-col'>
            ...
            {/* Input1 */}
            <input type='emaill' name='email' className='rounded-2xl px-2 py-1 w-4/5 md:w-full border-[1px] border-blue-400 m-1 focus:shadow-md focus:border-pink-400 focus:outline-none focus:ring-0' autocomplete="off" placeholder='Email' {...register("email", {
            ...
            {/* Input2 */}
            <input type="password" className='rounded-2xl px-2 py-1 w-4/5 md:w-full border-[1px] border-blue-400 m-1 focus:shadow-md focus:border-pink-400 focus:outline-none focus:ring-0' placeholder='Password' autocomplete="off" name="password"
              {...register("password", {
      ...
      <form className="bg-blue-400  rounded-2xl shadow-2xl  flex flex-col w-full  md:w-1/3 items-center max-w-4xl transition duration-1000 ease-in" onSubmit={handleSubmit(handleSignup)} >
        ...
        <div className='flex flex-col items-center justify-center mt-2'>
          ...
          <div className='flex flex-col'>
            ...
            {/* Input1 */}
            <input type="name" className='rounded-2xl px-2 py-1 w-4/5 md:w-full border-[1px] border-blue-400 m-1 focus:shadow-md focus:border-pink-400 focus:outline-none focus:ring-0' placeholder='Your Name' autocomplete="off" name="name"
              {...register("name", {
